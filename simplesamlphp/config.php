...
$config = [
    ...
    'technicalcontact_email' => 'amakenadog@gmail.com',
     ...
     */
    'secretsalt' => 'LJqFRq57Yql2nGWf6CK90wzALDN0bAKwKnLtkNjvf9s=',
     ...
     *
     */
    'module.enable' => array( 'sqlauth' => TRUE, ),
    ...
    'store.sql.dsn'                 => 'mysql:host=localhost;dbname=simplesamlphp_data_store',

    /*
     * The username and password to use when connecting to the database.
     */
    'store.sql.username' => 'root',
    'store.sql.password' => 'ppw2014',
