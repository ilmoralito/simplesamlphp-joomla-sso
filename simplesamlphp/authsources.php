...
$config = [
    ...
    'default-sp' => [
        ...
        'entityID' => 'https://simplesamlphp.local/simplesaml',

        // The entity ID of the IdP this SP should contact.
        // Can be NULL/unset, in which case the user will be shown a list of available IdPs.
        'idp' => 'https://simplesamlphp.local/simplesaml/saml2/idp/metadata.php',
        ...
        */
        ...
        // 'RelayState' => 'https://simplesamlphp.local/simplesaml', // Fix Caused by: SimpleSAML\Error\Exception: URL not allowed: http://joomla.local/?simplesamlphp=sso
    ...
    'example-sql' => [
        ...
        'username' => 'authuser',
        'password' => 'ppw2014',
        'query' => 'SELECT username FROM users WHERE username = :username AND AES_DECRYPT(password,"ppw2014") = :password',
    ],
